...
Créer un observatoire local des discriminations : collecte et publication de données sur les discriminations constatées (emploi, logement, services), recommandations, suivi des actions correctives.
