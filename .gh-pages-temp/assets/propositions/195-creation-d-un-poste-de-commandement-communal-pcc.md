...
Créer un Poste de Commandement Communal (PCC) : lieu d'activation immédiate en cas de crise, chaîne de décision claire, outils de communication, coordonnées à jour. Objectif : activation < 2h. Exercice de déclenchement au moins une fois par an.
